...
import com.jsp.shopping_cart.dao.*;
import com.jsp.shopping_cart.dto.*;
...
public class OrdersController {
	...
	public ModelAndView placeOrder(@ModelAttribute("ordersobj")Orders o,HttpSession session) {
		...
		for(Item i:items) {
			Product p=pdao.findProductbyId(i.getPid());//fetching product to get the stock of the product
